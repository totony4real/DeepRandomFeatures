...
from data_utils import get_mss_data
from models import initialize_model


if __name__ == "__main__":
    with open('/home/wch/DeepRandomFeatures/configs/example_config.yaml') as f:
        config = yaml.safe_load(f)

    zip_path = config['data']['zip_path']
    data_folder = config['data']['data_folder']
    spatial_X_train, temporal_X_train, y_train, spatial_X_test, temporal_X_test = get_mss_data(zip_path, data_folder)
